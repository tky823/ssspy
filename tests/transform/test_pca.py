...
def test_pca_real_2d(n_channels: int, n_samples: int):
    np.random.seed(111)
...
@pytest.mark.parametrize("n_channels", parameters_n_channels)
@pytest.mark.parametrize("n_samples", parameters_pca_real)
def test_pca_real_3d(batch_size: int, n_channels: int, n_samples: int):
    np.random.seed(111)
...
def test_pca_complex_3d(n_channels: int, n_bins: int, n_frames: int):
    np.random.seed(111)
...
@pytest.mark.parametrize("n_channels", parameters_n_channels)
@pytest.mark.parametrize("n_bins, n_frames", parameters_pca_complex)
def test_pca_complex_4d(batch_size: int, n_channels: int, n_bins: int, n_frames: int):
    np.random.seed(111)
